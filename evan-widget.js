(function(){
  ...
  root.querySelector('.evan-widget-head b').nextElementSibling.textContent='Assistant IA · réponses automatiques · validation par l’équipe';
